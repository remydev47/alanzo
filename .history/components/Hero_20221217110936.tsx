   ...
   <div className='relative'>
    <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
      <div className="w-full lg:w-2/3 xl:w-1/2">
        ...
        <p className="mt-8 font-erif text-xl font-normal text-[#fff]">
         Our professional and experienced Hospitality staff does the job right the first time are Carefully selected Give them a deep.
        </p>
      </div>
    </div>
   </div>
