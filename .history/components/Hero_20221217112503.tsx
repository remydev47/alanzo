...
const Hero = () => {
  return (
    <section className='relative pt-48 pb-12 xl:pt-60 sm:pb-16 lg:pb-32 xl:pb-48 2xl:pb-56 mt-2'>
    ...
    <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
      <div className="w-full lg:w-2/3 xl:w-1/2">
        ...
        <p className="mt-8 font-erif text-xl font-serif text-[#fff]">
          Hiring A Proffesional Chef for Family Dinners & Gatherings, Date Nights & Branchs, Parties & Get-togethers, and even Meal for entire Families !
        </p>
      </div>
    </div>
   </div>
